...
public class Vino implements Serializable {
    ...
    //Java: si dos objetos son iguales su hashcode tienen q ser iguales. Pero si el hashcode de dos objetos son el mismo no significa que dos objetos sean iguales.
}
